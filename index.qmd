...
if os.path.exists(archive_path):
    ...
    if not df_news.empty:
        ...
        # Security: Sanitize title and link to prevent Markdown injection and XSS
        ...
        df_news['published'] = df_news['published'].apply(lambda x: html.escape(str(x)).replace('[', '&#91;').replace(']', '&#93;'))
